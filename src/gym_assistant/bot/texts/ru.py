...
AI_OVERLOADED = (
    "Ассистент сейчас перегружен — это на стороне Anthropic, не у нас.\n\n"
    "Повтори вопрос через минуту, обычно проходит само. Денег это не стоило."
)
...
MEAL_DAY_EMPTY = (
    ...
    "Пришлите фото тарелки — разберу и посчитаю. Если что-то видно плохо, можно следом"
